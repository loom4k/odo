...
for i in range(len(label_names)):
    label = tk.Label(left_frame, text=label_names[i], font=("Arial", 18), padx=5, pady=(25/2), bg="white")
...
button_dot.grid(row=3, column=0, padx=(35/2), pady=10, sticky="nsew")
...
button_clear.grid(row=4, column=1, pady=40)
